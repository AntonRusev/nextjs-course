                ...
                isMobileMenuOpen && (
                    <div id='mobile-menu'>
                        <div className='space-y-1 px-2 pb-3 pt-2'>
                            ...
                            <Link
                                href='/properties'
                                className={`text-white block rounded-md px-3 py-2 text-base font-medium ${pathname === '/propeties' ? 'bg-black' : ''}`}
                            >
                                Properties
                            </Link>
                            {session
                                ...
                                <Link
                                    href='/properties/add'
                                    className={`text-white block rounded-md px-3 py-2 text-base font-medium ${pathname === '/propeties/add' ? 'bg-black' : ''}`}
                                >
                                    Add Property
                                </Link>
                                :
