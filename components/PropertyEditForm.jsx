...
function PropertyEditForm() {
    ...
    useEffect(() => {
        // Removing a warning? If the client side html structure does not match the server side?
        setMounted(true);
        ...
        const fetchPropertyData = async () => {
            try {
                ...
                // Check rates for null value and turn them into empty string
                if (propertyData && propertyData.rates) {
                    const defaultRates = { ...propertyData.rates };
                    for (const rate in defaultRates) {
                        if (defaultRates[rate] === 0) {
                            defaultRates[rate] = '';
                        };
                    };
